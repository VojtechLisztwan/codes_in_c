...
tests = []
tests.append({'name': 'test-wrong-input', 'title': 'Wrong input', 'exit_code': 1, 'args': ['AAPL'], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-ticker-404', 'title': 'Ticker 404', 'exit_code': 0, 'args': ['AMC', '10'], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-small', 'title': 'Small', 'exit_code': 0, 'args': ['TSLA', '5'], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-medium', 'title': 'Medium', 'exit_code': 0, 'args': ['AAPL', '25'], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
tests.append({'name': 'test-large', 'title': 'Large', 'exit_code': 0, 'args': ['NVDA', '200'], 'stdin': 'stdin', 'stdout': 'stdout', 'stderr': None, 'files_in': [], 'files_out': []})
